...
$sql = "SELECT * FROM inventory LIMIT $offset, $itemsPerPage";
...
<body>
    ...
    <main>
        <div class="header-container">
            <h1>Equipments and Machineries</h1>
            <button class="add-button" onclick="location.href='add_item.php';">+Add New</button>
        </div><br>
    ...
    <script>
            ...
            $.ajax({
                ...
                <div class="details-content">
                    ...
                    <div class="details-actions">
                        ...
                        <button class="show-maintenance-history" onclick="showMaintenanceHistory(${itemId})">History</button>
                    </div>
                </div>
            `;
        ...
        function editItem(itemId) {
            window.location.href = 'update_inv_details.php?id=' + itemId;
        }
