...
$projects = $conn->query("SELECT DISTINCT project_name FROM request WHERE status = 0 LIMIT $offset, $itemsPerPage");
?>
...
<body>
    ...
    <main>
        ...
        <div class="action">
            ...
            <button class='reject-btn' onclick='confirmRejectRequest()'>Decline</button>
        </div><br>
        <div class="inventory-container">
            ...
            if ($projects->num_rows > 0) {
                while ($project = $projects->fetch_assoc()) {
                    ...
                    $sql = "SELECT * FROM request WHERE project_name = '$projectName' AND status = 0";
    ...
    <script>
        ...
        function confirmRejectRequest() {
            ...
            document.querySelector('#reject-confirmation-overlay .btn-yes').onclick = () => submitRejectItems(itemIds);
            document.querySelector('#reject-confirmation-overlay .btn-no').onclick = cancelRejectItem;
        }
